      ...
      {patente !== 0 && (
        <div className="pl-3 text-lg h-14.5 gap-1.5 flex flex-col items-baseline border-l border-neutral-400/20">
          ...
          <div className="flex gap-1.5">
            <button className="text-xs py-0.5 px-2 rounded-full bg-white/60 hover:bg-white/30 focus:bg-white/30 transition-colors cursor-pointer grow text-black justify-center items-center flex">
              {/* ...SVG... */}
