  ...
  return (
    <div className="fixed flex items-center gap-3 p-3 border rounded-md shadow-lg bottom-3 left-3 border-neutral-400/20 bg-background/85 backdrop-blur-sm">
      ...
      <h3
        className={`${
          patente === 0 ? "hidden" : ""
        } transition-colors absolute -top-[1px] left-1.5 -translate-y-full font-medium font-mono min-h-8 min-w-23 flex flex-nowrap justify-center items-center border-x border-t rounded-t-xl w-fit ${clase.fondo} ${clase.texto} ${clase.bordeFondo}`}
      >
      ...
      {patente !== 0 && (
        <div className="pl-3 text-lg h-14.5 gap-1.5 flex flex-col items-baseline border-l border-neutral-400/20">
          ...
          <div className="flex gap-1.5">
            ...
            <button onClick={() => alert("Funcionalidad no implementada")} className="text-xs py-0.5 px-2 rounded-full bg-white/60 hover:bg-white/30 focus-visible:bg-white/30 transition-colors cursor-pointer grow text-black justify-center items-center flex">
